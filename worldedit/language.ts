...
export namespace WorldeditLangs {
	...
	export namespace TaskSuccess {
		export const usedTime = Language === "ko_kr" ? "초 소요" : "Secs used";
		...
		export const replace = Language === "ko_kr" ? "블럭 중 일부를 바꿨습니다" : "blocks in the area as replace block have been changed";
